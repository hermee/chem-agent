...
export class Workflow {
  steps = [
    ...
    { id: 2, icon: '🔄', title: 'Query Rewrite', description: 'Rewrites question to be self-contained using chat history (Claude 3.5 Haiku)', color: 'linear-gradient(135deg, #64748b, #94a3b8)' },
    { id: 3, icon: '🧭', title: 'Router', description: 'Classifies query as synthesis, lookup, or general (Claude 3.5 Haiku)', color: 'linear-gradient(135deg, #3b82f6, #6366f1)' },
    { id: 4, icon: '🔍', title: 'FAISS Retrieval + Rerank', description: '454 vectors searched + LLM reranking (Claude 3.5 Haiku)', color: 'linear-gradient(135deg, #3b82f6, #6366f1)' },
